...
add_action( 'init', 'additional_menus' );

require_once('library/remove_menu_items.php');

require_once('library/link_excerpts.php');

require_once( 'library/community_members.php' );
